...
public class ActivityIntroEvaluate3 extends AppCompatActivity {

    ImageButton btnsig,btnatras;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.intro_evaluate3);
    ...
    public void Atras(){
        Intent intent = new Intent(this,ActivityIntroEvaluate2.class);
        startActivity(intent);
    }
}