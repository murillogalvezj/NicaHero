...
public class ActivityIntroEvaluate2 extends AppCompatActivity {

    ImageButton btnsig,btnatras;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.intro_evaluate2);
    ...
    public void Atras(){
        Intent intent = new Intent(this,ActivityIntroEvaluate1.class);
        startActivity(intent);
    }
}