...
public class ActivityIntroAprende3 extends AppCompatActivity {

    ImageButton btnsig,btnatras;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.intro_aprende3);
    ...
    public void Siguiente(){
        Intent intent = new Intent(this,ActivityIntroAprende4.class);
